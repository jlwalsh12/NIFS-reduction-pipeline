...
for i=0, n_elements(telluric_file)-1 do begin
   ...
   ;
   s = size(temp2)
   goodpixels = [range(30,s[1]-30)]
   case grating of
      "Z":goodpixels = [range(900,1300),range(2600,3000)]+100
      "J":goodpixels = [range(30,s[1]-30)]
      "H":goodpixels = [range(30,s[1]-30)]
      "K":goodpixels = [range(1300,1800)]
      else:
   endcase
