...
procedure xzap_jonelle (inlist, omasks, outlist, crmasks)

# Calls xdimsum scripts fileroot.cl, iterstat.cl, makemask_jonelle.cl, minv.cl
#
...
# Object masking:  create mask identifying where objects might be.
		...
		makemask_jonelle ("_fmedtemp", "_objfmedtemp" // ".pl",
