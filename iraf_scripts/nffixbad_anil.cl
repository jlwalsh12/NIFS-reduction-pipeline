...
# ACS edits (12/08):
#
# modified nffixbad.cl to do a better treatment of the variance
# extensions. Instead of setting the variance of 'fixed' pixels to
# very high values, this version interpolates with IRAF's fixpix.
