...
#include xc and yc for galaxy image; won't extract a 1D spectrum
#interactively. JLW 2017
real xc          {           prompt="X-position (pixels) for automatic extraction"}
real yc          {           prompt="Y-position (pixels) for automatic extraction"}
...
#include xc and yc for galaxy image; won't extract a 1D spectrum interactively. JLW 2017
real l_threshold, l_shift, l_scale, l_dshift, l_dscale,l_wstart,l_wend,l_delta,l_xc,l_yc
...
#  had to edit ACS 2008 to allow for a non-interactive 1D extraction (will pass in xc and yc instead); JLW 2017
     nfextract(imgin,outspectra=tmpsci1d,outprefix="",fl_inter=no, xc=l_xc, yc=l_yc,dispaxis=l_dispaxis, logfile=l_logfile,verbose-)
