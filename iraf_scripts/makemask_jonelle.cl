...
procedure makemask_jonelle (inlist, outlist)
...
#
# JLW edits to makemask.cl (1/17):
#
# modfied a call to fmedian where the duplicate zloreject=INDEF was corrected.
...
# been fixed in IRAF version 2.10.1.
		...
		if (checklimits) {
			...
			#JLW edit 1/21/17: fmedian call below
                        #originally had zloreject=INDEF,
                        #zloreject=INDEF and changed to
